    ...
    <body>
        ...
        <div class="container mt-5 text-center">
            <marquee class="text-danger">
                <label style="font-family: roboto; font-size: 30px; font-weight: 700;">Bem vindo ao sistema de Cadastro</label>
            </marquee>

            <div class=" mt-5 table">
                <div class="row">
                    <div class="col">
                        <img src="img/pacotes.png" alt="200" width="300"/>
                        <a href="pacotes.jsp"><label style="font-family; roboto; font-size: 20px; font-weight: 500;">Cadastrar Pacotes</label></a>
                    </div>
                    <div class="col">
                        <img src="img/promocao.png" alt="200" width="160"/>
                        <a href="promocao.jsp"><label style="font-family; roboto; font-size: 20px; font-weight: 500;">Cadastrar Promocao</label></a>
                    </div>
                    <div class="col">
                        <br>
                        <img src="img/usuario.png" alt="200" width="170"/>
                        <a href="funcionario.jsp"><label style="font-family; roboto; font-size: 20px; font-weight: 500;">Cadastrar Funcionário</label></a>
                    </div>
                </div>
            </div>
        </div>
